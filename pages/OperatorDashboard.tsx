      ...
      <div className="flex flex-col gap-4 pb-20">
         <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-3">
            ...
            <div className="flex items-center gap-2">
                 <div className="relative"><Search className="absolute left-3 top-2.5 text-slate-400" size={14}/><input type="text" placeholder="Cari Guru / Mapel..." className="pl-8 pr-3 py-1.5 bg-slate-100 border border-slate-200 rounded-xl text-xs focus:ring-2 focus:ring-blue-500 w-40" value={searchTerm} onChange={e => setSearchTerm(e.target.value)}/></div>
