      ...
      <div className="flex flex-col gap-4 pb-20">
         <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-3">
            ...
            <div className="flex items-center gap-2">
                 <div className="relative"><Search className="absolute left-3 top-2.5 text-slate-400" size={14}/><input type="text" placeholder="Cari Guru / Mapel..." className="text-slate-900 dark:text-slate-100 bg-slate-50 dark:bg-slate-800 pl-8 pr-3 py-1.5 border border-slate-200 rounded-xl text-xs focus:ring-2 focus:ring-blue-500 w-40 dark: dark: dark:border-slate-600" value={searchTerm} onChange={e => setSearchTerm(e.target.value)}/></div>
