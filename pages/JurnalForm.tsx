                ...
                {inputMode === 'manual' ? (
                    <div className="w-full max-w-md">
                        ...
                        <div className="grid grid-cols-2 gap-4">
                            <select className="text-slate-900 dark:text-slate-100 bg-slate-50 dark:bg-slate-800 border p-3 rounded-xl dark: dark: dark:border-slate-600" value={formData.kelas} onChange={(e) => { setFormData({...formData, kelas: e.target.value}); }}>
                                <option value="">- Pilih Kelas -</option>
                                {availableClasses.map(c => <option key={c} value={c}>{c}</option>)}
                            </select>
                            <input 
                                type="text" 
                                className="text-slate-900 dark:text-slate-100 bg-slate-50 dark:bg-slate-800  border p-3 rounded-xl dark: dark: dark:border-slate-600" 
