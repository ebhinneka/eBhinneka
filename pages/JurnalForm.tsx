                ...
                {inputMode === 'manual' ? (
                    <div className="w-full max-w-md">
                        ...
                        <div className="grid grid-cols-2 gap-4">
                            <select className="border p-3 rounded-xl bg-slate-100" value={formData.kelas} onChange={(e) => { setFormData({...formData, kelas: e.target.value}); }}>
